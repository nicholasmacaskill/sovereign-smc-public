...
class AIValidator:
    ...
    def analyze_trade(self, setup, sentiment, whales, image_path=None):
        ...
        prompt = f"""
        YOU ARE THE SOVEREIGN GATEKEEPER. You are the Head of Intraday Flow at a tier-one institution. 
        Your mission is to protect our 6% Max Drawdown limit while extracting capital from the NY Session.
        ...
        1. THE 6% ABYSS: We trade at 0.75% risk. Strategy drift is failure.
        2. ORACLE SYNCHRONICITY: Does this setup match the Oracle Ground Truth cited above? 
        3. LIQUIDITY DRAW: Identify FVG or Swing High/Low. If R:R < 1:3, REJECT.
        """
