...
def main():
    ...
    with open(os.path.join(DEST_DIR, ".github", "workflows", "publish-package.yml"), "w") as f:
        f.write("""name: Publish Package (Container)
...
env:
  REGISTRY: ghcr.io
  IMAGE_NAME: ${{ github.repository }}/tradelocker-python
      ...
      - name: Extract metadata (tags, labels) for Docker
        ...
        with:
          ...
          tags: |
            ...
            type=raw,value=v0.1.0

      # Create a simple Dockerfile on the fly if it doesn't exist
